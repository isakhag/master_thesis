...
# shapefile_path = "C:/Users/Isak9/OneDrive - NTNU/5. året NTNU/Fordypningsprosjekt/Ottadalen-NGI/Release point Ottadalen.shp"
...
#     x, y = int(round(geometry.x)), int(round(geometry.y))
#     x_coords.append(x)
#     y_coords.append(y)
# coordinates = [(x, y) for x, y in zip(x_coords, y_coords)]

# print("Coordinates for all points:", coordinates)
#coordinates index is the same as coordinate FID in arcgis.
    ...
    # plt.ylabel('Latitude')
    # plt.title('Polygon Coordinates')
    # plt.grid(True)
    # plt.show()

# Iterate through the "geometry" column


''''
    Example on how to extract raster values at points locations with python. 
    The result is saved as .csv.
    The histograms from the results can be later computed with numpy and plotted with python.
    
    Rosa M Palau - NGI (22.11.2023)
'''
...
#%%POINTS SWECO INSIDE STUDY AREA
# input data
# input_shapefile = "C:/Users/Isak9/OneDrive - NTNU/5. året NTNU/Fordypningsprosjekt/slope/points2.shp"
...
#%% soil type and skredtype, brukes nå i 2024
