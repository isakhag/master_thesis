...
# plt.title('Landslides and Landslide Frequencies of Tree Amount with Diameter > 5cm', fontsize=16)
# plt.tight_layout()
# plt.show()
...
# plt.title('Landslides and Landslide Frequencies of Tree Amount With Diameter > 16cm', fontsize=16)
# ax1.set_xticklabels(bin_labels, fontsize=14) 
# plt.tight_layout()
# plt.show()
